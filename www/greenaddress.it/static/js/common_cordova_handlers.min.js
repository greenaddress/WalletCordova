...
var commonNFCXGaitMNCListener = function(nfcEvent) {
    ...
    for (var i = 0; i < message.length; i++) {
        ...
        if (type == 'x-gait/mnc') {
            ...
            if (window.cordova) {
                window.location.href = BASE_URL + '/' + LANG + '/wallet.html#/#' + Crypto.util.bytesToBase64(data);
            } else {
                window.location.href = '/' + LANG + '/wallet#/#'+Crypto.util.bytesToBase64(data);
            }
            break;
        }
    }            
