...
return ['$scope', '$location', 'mnemonics', 'tx_sender', 'notices', 'wallets', '$window', 'facebook', '$modal', 'gaEvent', '$q', 'reddit', 'storage', 'trezor', 'bip38',
        function SignupController($scope, $location, mnemonics, tx_sender, notices, wallets, $window, facebook, $modal, gaEvent, $q, reddit, storage, trezor, bip38) {
    ...
    $scope.signup.encrypt_mnemonic = function() {
        ...
        bip38.encrypt_mnemonic_modal($scope, entropy).then(function(encrypted) {
