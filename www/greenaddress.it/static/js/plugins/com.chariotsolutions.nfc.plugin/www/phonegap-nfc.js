...
var textHelper = {
    ...
    decodePayload: function (data) {
        ...
        return nfcutil.bytesToString(data.slice(languageCodeLength + 1));
    },
    ...
    encodePayload: function(text, lang, encoding) {
        ...
        var encoded = nfcutil.stringToBytes(lang + text);
...
var uriHelper = {
    ...
    decodePayload: function (data) {
        ...
        return prefix + nfcutil.bytesToString(data.slice(1));
    },
    ...
    encodePayload: function (uri) {
        ...
        encoded = nfcutil.stringToBytes(uri.slice(prefix.length));
...
// create aliases
nfc.bytesToString = nfcutil.bytesToString;
nfc.stringToBytes = nfcutil.stringToBytes;
nfc.bytesToHexString = nfcutil.bytesToHexString;
